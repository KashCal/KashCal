 ...
 * change to a cosmetic property (title, notes, location text, categories,
 * colour) does NOT invalidate a prior acceptance, so bumping SEQUENCE for it
 * would make attendee clients re-surface the invitation and re-notify for
 * nothing.
 *
 * Significant properties (bump): DTSTART, DTEND, DURATION, RRULE, RDATE,
 * EXDATE, and a transition of STATUS to CANCELLED.
 *
