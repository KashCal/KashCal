...
import org.onekash.kashcal.ui.shared.SyncOption
...
fun SyncFrequencySheet(
    ...
    ModalBottomSheet(
        ...
        Column(
            ...
            Text(
                text = stringResource(R.string.settings_sync_frequency_hint),
            ...
            getSyncOptions(LocalResources.current).forEach { option ->
                SyncFrequencyOptionRow(
                    option = option,
                    isSelected = currentIntervalMs == option.intervalMs,
                    onSelect = {
                        onSelect(option.intervalMs)
                        onDismiss()
                    }
                )
            }
...
@Composable
private fun SyncFrequencyOptionRow(
    option: SyncOption,
    isSelected: Boolean,
    onSelect: () -> Unit
) {
